...
// const uri = "mongodb+srv://QuickTask:dkxw6DQTZjqVDJZx@cluster0.2vtceto.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
async function run() {
  try {
    ...
    const userCollection = client.db('MICRO_EARNING_DB').collection('USER_COLLECTION')
